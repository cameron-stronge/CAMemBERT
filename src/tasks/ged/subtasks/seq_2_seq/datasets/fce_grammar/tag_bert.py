...
from src.models.transformer_models import TaggingModel
...
task = 'ged'
subtask = 'seq_2_seq'
abrev_name = f'tagging_bert_weighted_loss_func_{dataset_title}'
...
model = TaggingModel(pre_trained_model_name,labels,class_weights_tensor)
